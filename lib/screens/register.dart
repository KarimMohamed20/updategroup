...
class _RegisterState extends State<Register> {
          ...
          children: <Widget>[
            ...
            facebookGoogleRegister
                ...
                : inputField(
                    ...
                    true),
            Divider(height: 15.0),
            inputField('العنوان', 'العنوان', TextInputType.text,
                _adressController, true, false),
            addressInput(),
            Divider(height: 13.0),
            inputField('رقم الهاتف', ' أدخل رقم الهاتف ', TextInputType.phone,
                _phoneController, false, false),
            Divider(height: 13.0),
  ...
  Widget inputField(String label, String hintText, TextInputType type,
      TextEditingController controller, bool disabled, bool obscure) {
    return Column(
      children: <Widget>[
        new Row(
          children: <Widget>[
  ...
  Widget registerButton(bool fgS) {
    return Container(
      ...
      child: UI.button(context, 'تسجيل', Colors.deepOrange[600],
          FontAwesomeIcons.userCircle, null, null, () async {
        if (_emailController.text.isEmpty ||
          ...
          if (fgS) {
            registerSuccessful(_emailController.text, _adressController.text,
                _phoneController.text.isEmpty ? ' ' : _phoneController.text);
          } else {
            if (_passwordController.text.isEmpty ||
                _passwordController.text.length < 6) {
              UI.dialog(context, 'برجاء ادخال كلمة مرور سليمة',
                  'تأكد من كلمة المرور ', 'اعد المحاولة');
            } else {
              FirebaseUser user = await Auth.instance.emailPasswordSignUp(
              ...
              if (currentUser != null &&
                ...
                UI.dialog(
                    context,
                    'برجاء ادخال بيانات سليمة',
                    'تأكد من كلمة المرور و ان البريد الذي تقوم بالتسجيل به ليس مسجل مسبقا',
                    'اعد المحاولة');
              }
            }
          }
